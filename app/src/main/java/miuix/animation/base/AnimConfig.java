...
public class AnimConfig {
    ...
    public final Map<String, AnimSpecialConfig> mSpecialNameMap;
    @Deprecated
    ...
    public final AnimSpecialConfig queryAndCreateSpecial(FloatProperty floatProperty, boolean z) {
    ...
    public final AnimSpecialConfig queryAndCreateSpecial(String str, boolean z) {
