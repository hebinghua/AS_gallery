...
public class SlidingSwitchCompat extends SwitchCompat {
    ...
    public static /* synthetic */ boolean $r8$lambda$rL8bX7HfaEcSeNohQFUdozyRkoU(SlidingSwitchCompat slidingSwitchCompat, View view, MotionEvent motionEvent) {
        return slidingSwitchCompat.lambda$new$0(view, motionEvent);
    }
    ...
    public SlidingSwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        setOnHoverListener(new View.OnHoverListener() { // from class: miuix.slidingwidget.widget.SlidingSwitchCompat$$ExternalSyntheticLambda0
            ...
            public final boolean onHover(View view, MotionEvent motionEvent) {
                return SlidingSwitchCompat.$r8$lambda$rL8bX7HfaEcSeNohQFUdozyRkoU(SlidingSwitchCompat.this, view, motionEvent);
            }
        });
    }
