...
public final class R$styleable {
    ...
    public static final int[] FloatingActionButton = {R.attr.fabColor, R.attr.fabShadowEnabled};
    ...
    public static final int[] GroupButton = {R.attr.miuixSelectGroupButtonBackground};
