...
public final class ServerMsgMap {
    public static TwoKeyHashMap<Integer, String, Integer> CODE_MAP = new TwoKeyHashMap<>();
    ...
    static {
        ...
        add2Map(StatusCode.BAD_REQUEST, 240001, "bad parameters");
        add2Map(StatusCode.BAD_REQUEST, 240002, "bad request");
        add2Map(StatusCode.BAD_REQUEST, 240003, "no such api implemented");
        add2Map(StatusCode.BAD_REQUEST, 240001, "clientBadParams");
        add2Map(StatusCode.BAD_REQUEST, 240004, "serverError");
        add2Map(StatusCode.BAD_REQUEST, 240005, "accountServerError");
        add2Map(StatusCode.BAD_REQUEST, 240006, "unknownError");
        add2Map(StatusCode.BAD_REQUEST, 240007, "requestFail");
        add2Map(StatusCode.BAD_REQUEST, 240008, "mobileExists");
        add2Map(StatusCode.BAD_REQUEST, 240009, "sendMsgError");
        add2Map(StatusCode.BAD_REQUEST, 240010, "tooManyRequests");
        add2Map(StatusCode.BAD_REQUEST, 240011, "tooOften");
        add2Map(StatusCode.BAD_REQUEST, 240012, "invalidCode");
        add2Map(StatusCode.BAD_REQUEST, 240013, "invalidMobile");
        add2Map(StatusCode.BAD_REQUEST, 240014, "emptyPassword");
        add2Map(StatusCode.BAD_REQUEST, 240015, "passwordTooLong");
        add2Map(StatusCode.BAD_REQUEST, 240016, "noSuchUser");
        add2Map(StatusCode.BAD_REQUEST, 240014, "needPassword");
        add2Map(StatusCode.BAD_REQUEST, 240017, "canNotSetPassword");
        add2Map(StatusCode.BAD_REQUEST, 240018, "verifyNotRequest");
        add2Map(StatusCode.BAD_REQUEST, 240020, "expiredCode");
        add2Map(StatusCode.BAD_REQUEST, 240019, "file not exist");
        ...
        add2Map(StatusCode.FORBIDDEN, 240301, "file exist");
        add2Map(StatusCode.FORBIDDEN, 240302, "forbidden");
        add2Map(404, 240401, "file not exist");
        add2Map(406, 240601, "too many files");
        add2Map(StatusCode.REQUEST_ENTITY_TOO_LARGE, 241301, "file too large");
    ...
    public static void add2Map(int i, int i2, String str) {
