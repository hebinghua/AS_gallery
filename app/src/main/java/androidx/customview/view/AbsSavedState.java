...
public abstract class AbsSavedState implements Parcelable {
    ...
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new Parcelable.ClassLoaderCreator<AbsSavedState>() { // from class: androidx.customview.view.AbsSavedState.2
        ...
        public AbsSavedState mo82createFromParcel(Parcel parcel, ClassLoader classLoader) {
        ...
        /* renamed from: createFromParcel */
        public AbsSavedState mo81createFromParcel(Parcel parcel) {
            return mo82createFromParcel(parcel, (ClassLoader) null);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: newArray */
        public AbsSavedState[] mo83newArray(int i) {
