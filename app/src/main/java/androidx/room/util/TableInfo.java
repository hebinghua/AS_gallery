...
public class TableInfo {
    ...
    public String toString() {
        return "TableInfo{name='" + this.name + CoreConstants.SINGLE_QUOTE_CHAR + ", columns=" + this.columns + ", foreignKeys=" + this.foreignKeys + ", indices=" + this.indices + '}';
    }
    ...
    public static Map<String, Column> readColumns(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            if (query.getColumnCount() > 0) {
                ...
                int columnIndex2 = query.getColumnIndex(nexExportFormat.TAG_FORMAT_TYPE);
    ...
    public static Set<Index> readIndices(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            int columnIndex = query.getColumnIndex("name");
            int columnIndex2 = query.getColumnIndex(MiStat.Param.ORIGIN);
    ...
    public static class Column {
        ...
        public String toString() {
            return "Column{name='" + this.name + CoreConstants.SINGLE_QUOTE_CHAR + ", type='" + this.type + CoreConstants.SINGLE_QUOTE_CHAR + ", affinity='" + this.affinity + CoreConstants.SINGLE_QUOTE_CHAR + ", notNull=" + this.notNull + ", primaryKeyPosition=" + this.primaryKeyPosition + ", defaultValue='" + this.defaultValue + CoreConstants.SINGLE_QUOTE_CHAR + '}';
        }
    }
    ...
    public static class ForeignKey {
        ...
        public String toString() {
            return "ForeignKey{referenceTable='" + this.referenceTable + CoreConstants.SINGLE_QUOTE_CHAR + ", onDelete='" + this.onDelete + CoreConstants.SINGLE_QUOTE_CHAR + ", onUpdate='" + this.onUpdate + CoreConstants.SINGLE_QUOTE_CHAR + ", columnNames=" + this.columnNames + ", referenceColumnNames=" + this.referenceColumnNames + '}';
        }
    }
    ...
    public static class Index {
        ...
        public String toString() {
            return "Index{name='" + this.name + CoreConstants.SINGLE_QUOTE_CHAR + ", unique=" + this.unique + ", columns=" + this.columns + '}';
        }
    }
}
