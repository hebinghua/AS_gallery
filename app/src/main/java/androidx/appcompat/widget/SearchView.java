...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public void onActionViewExpanded() {
        ...
        this.mSearchSrcTextView.setImeOptions(imeOptions | nexEngine.ExportHEVCHighTierLevel62);
        this.mSearchSrcTextView.setText("");
        setIconified(false);
    }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: androidx.appcompat.widget.SearchView.SavedState.1
            ...
            public SavedState mo53createFromParcel(Parcel parcel, ClassLoader classLoader) {
    ...
    public final Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        ...
        try {
            ...
            if (columnString3 != null && (columnString = SuggestionsAdapter.getColumnString(cursor, "suggest_intent_data_id")) != null) {
                columnString3 = columnString3 + h.g + Uri.encode(columnString);
            }
