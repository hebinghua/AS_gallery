...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    public LayoutParams mo46generateDefaultLayoutParams() {
    ...
    public LayoutParams mo47generateLayoutParams(AttributeSet attributeSet) {
        return new LayoutParams(getContext(), attributeSet);
    }

    @Override // androidx.appcompat.widget.LinearLayoutCompat, android.view.ViewGroup
    /* renamed from: generateLayoutParams  reason: collision with other method in class */
    public LayoutParams mo48generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        ...
        return mo46generateDefaultLayoutParams();
    }
    ...
    public LayoutParams generateOverflowButtonLayoutParams() {
        LayoutParams mo46generateDefaultLayoutParams = mo46generateDefaultLayoutParams();
        mo46generateDefaultLayoutParams.isOverflowButton = true;
        return mo46generateDefaultLayoutParams;
    }
