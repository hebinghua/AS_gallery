...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public void autoSizeText() {
        ...
        if (this.mNeedsAutoSizeText) {
            ...
            int measuredWidth = this.mImpl.isHorizontallyScrollable(this.mTextView) ? nexEngine.ExportHEVCMainTierLevel6 : (this.mTextView.getMeasuredWidth() - this.mTextView.getTotalPaddingLeft()) - this.mTextView.getTotalPaddingRight();
    ...
    public final StaticLayout createStaticLayoutForMeasuringPre23(CharSequence charSequence, Layout.Alignment alignment, int i) {
