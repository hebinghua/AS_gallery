...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public final FragmentViewHolder mo1843onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    public final void scheduleViewAttach(final Fragment fragment, final FrameLayout frameLayout) {
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        public final ViewPager2 inferViewPager(RecyclerView recyclerView) {
