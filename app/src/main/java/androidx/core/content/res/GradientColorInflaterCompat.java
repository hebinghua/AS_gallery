...
public final class GradientColorInflaterCompat {
    public static Shader createFromXmlInner(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        int namedInt = TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, nexExportFormat.TAG_FORMAT_TYPE, R$styleable.GradientColor_android_type, 0);
    ...
    */
    public static androidx.core.content.res.GradientColorInflaterCompat.ColorStops inflateChildElements(android.content.res.Resources r9, org.xmlpull.v1.XmlPullParser r10, android.util.AttributeSet r11, android.content.res.Resources.Theme r12) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            int r0 = r10.getDepth()
            r1 = 1
            int r0 = r0 + r1
