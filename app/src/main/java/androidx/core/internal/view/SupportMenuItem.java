...
public interface SupportMenuItem extends MenuItem {
    ...
    MenuItem mo39setActionView(int i);
    ...
    SupportMenuItem mo41setContentDescription(CharSequence charSequence);
    ...
    MenuItem mo42setShowAsActionFlags(int i);

    SupportMenuItem setSupportActionProvider(ActionProvider actionProvider);

    @Override // android.view.MenuItem
    /* renamed from: setTooltipText */
    SupportMenuItem mo43setTooltipText(CharSequence charSequence);
}
