...
public class AccessibilityNodeInfoCompat {
    ...
    public static String getActionSymbolicName(int i) {
        if (i != 1) {
            ...
            switch (i) {
                ...
                case nexEngine.ExportHEVCMainTierLevel52 /* 262144 */:
                    return "ACTION_EXPAND";
                case nexEngine.ExportHEVCHighTierLevel52 /* 524288 */:
                    return "ACTION_COLLAPSE";
                case nexEngine.ExportHEVCHighTierLevel6 /* 2097152 */:
    ...
    public static class AccessibilityActionCompat {
        ...
        public static final AccessibilityActionCompat ACTION_EXPAND = new AccessibilityActionCompat(nexEngine.ExportHEVCMainTierLevel52, null);
        public static final AccessibilityActionCompat ACTION_COLLAPSE = new AccessibilityActionCompat(nexEngine.ExportHEVCHighTierLevel52, null);
        public static final AccessibilityActionCompat ACTION_DISMISS = new AccessibilityActionCompat(nexEngine.ExportHEVCMainTierLevel6, null);
        public static final AccessibilityActionCompat ACTION_SET_TEXT = new AccessibilityActionCompat(nexEngine.ExportHEVCHighTierLevel6, null, AccessibilityViewCommand.SetTextArguments.class);
