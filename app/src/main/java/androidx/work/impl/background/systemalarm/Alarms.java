...
public class Alarms {
    ...
    public static void cancelExactAlarm(Context context, String workSpecId, int alarmId) {
    ...
    public static void setExactAlarm(Context context, String workSpecId, int alarmId, long triggerAtMillis) {
        AlarmManager alarmManager = (AlarmManager) context.getSystemService("alarm");
        int i = Build.VERSION.SDK_INT;
        PendingIntent service = PendingIntent.getService(context, alarmId, CommandHandler.createDelayMetIntent(context, workSpecId), i >= 23 ? 201326592 : Box.MAX_BOX_SIZE);
