...
public class DiagnosticsWorker extends Worker {
    ...
    public static String workSpecRows(WorkNameDao workNameDao, WorkTagDao workTagDao, SystemIdInfoDao systemIdInfoDao, List<WorkSpec> workSpecs) {
    ...
    public static String workSpecRow(WorkSpec workSpec, String name, Integer systemId, String tags) {
