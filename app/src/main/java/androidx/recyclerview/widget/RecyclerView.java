...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, NestedScrollingChild3 {
    ...
    public final void nestedScrollByInternal(int i, int i2, MotionEvent motionEvent, int i3) {
        ...
        if (layoutManager == null) {
            ...
            int i5 = canScrollHorizontally != 0 ? i : 0;
            if (canScrollVertically) {
                i4 = i2;
            }
    ...
    */
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public abstract VH mo1843onCreateViewHolder(ViewGroup viewGroup, int i);
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int i) {
            try {
                ...
                VH mo1843onCreateViewHolder = mo1843onCreateViewHolder(viewGroup, i);
                if (mo1843onCreateViewHolder.itemView.getParent() != null) {
                    throw new IllegalStateException("ViewHolder views must not be attached when created. Ensure that you are not passing 'true' to the attachToRoot parameter of LayoutInflater.inflate(..., boolean attachToRoot)");
                }
                mo1843onCreateViewHolder.mItemViewType = i;
                return mo1843onCreateViewHolder;
            } finally {
                TraceCompat.endSection();
            }
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: androidx.recyclerview.widget.RecyclerView.SavedState.1
            ...
            public SavedState mo139createFromParcel(Parcel parcel, ClassLoader classLoader) {
            ...
            public SavedState[] mo140newArray(int i) {
