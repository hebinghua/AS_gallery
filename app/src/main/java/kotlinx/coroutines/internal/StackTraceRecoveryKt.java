...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            str = Result.m2569constructorimpl(Class.forName(str2).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            str = Result.m2569constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m2571exceptionOrNullimpl(str) == null) {
            str2 = str;
        }
        baseContinuationImplClassName = str2;
        try {
            Result.Companion companion3 = Result.Companion;
            m2569constructorimpl = Result.m2569constructorimpl(StackTraceRecoveryKt.class.getCanonicalName());
        } catch (Throwable th2) {
        ...
        if (Result.m2571exceptionOrNullimpl(m2569constructorimpl) != null) {
            m2569constructorimpl = "kotlinx.coroutines.internal.StackTraceRecoveryKt";
        }
        stackTraceRecoveryClassName = (String) m2569constructorimpl;
    }
