...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    public final RequestManager getApplicationManager(Context context) {
    ...
    public final Fragment findSupportFragment(View view, FragmentActivity fragmentActivity) {
    ...
    @Deprecated
    public final android.app.Fragment findFragment(View view, Activity activity) {
    ...
    @TargetApi(26)
    @Deprecated
    public final void findAllFragmentsWithViews(FragmentManager fragmentManager, ArrayMap<View, android.app.Fragment> arrayMap) {
    ...
    @Deprecated
    public final void findAllFragmentsWithViewsPreO(FragmentManager fragmentManager, ArrayMap<View, android.app.Fragment> arrayMap) {
        int i = 0;
        while (true) {
            int i2 = i + 1;
            this.tempBundle.putInt(Action.KEY_ATTRIBUTE, i);
            android.app.Fragment fragment = null;
            try {
                fragment = fragmentManager.getFragment(this.tempBundle, Action.KEY_ATTRIBUTE);
    ...
    public final RequestManagerFragment getRequestManagerFragment(FragmentManager fragmentManager, android.app.Fragment fragment) {
    ...
    @Deprecated
    public final RequestManager fragmentGet(Context context, FragmentManager fragmentManager, android.app.Fragment fragment, boolean z) {
    ...
    public final SupportRequestManagerFragment getSupportRequestManagerFragment(androidx.fragment.app.FragmentManager fragmentManager, Fragment fragment) {
    ...
    public final RequestManager supportFragmentGet(Context context, androidx.fragment.app.FragmentManager fragmentManager, Fragment fragment, boolean z) {
