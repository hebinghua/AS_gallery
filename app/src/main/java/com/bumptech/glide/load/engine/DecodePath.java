...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    public final Resource<ResourceType> decodeResource(DataRewinder<DataType> dataRewinder, int i, int i2, Options options) throws GlideException {
    ...
    public final Resource<ResourceType> decodeResourceWithList(DataRewinder<DataType> dataRewinder, int i, int i2, Options options, List<Throwable> list) throws GlideException {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            try {
                if (resourceDecoder.handles(dataRewinder.mo993rewindAndGet(), options)) {
                    resource = resourceDecoder.decode(dataRewinder.mo993rewindAndGet(), i, i2, options);
                }
