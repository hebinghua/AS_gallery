...
public final class DataUrlLoader<Model, Data> implements ModelLoader<Model, Data> {
    ...
    public interface DataDecoder<Data> {
        ...
        /* renamed from: decode */
        Data mo229decode(String str) throws IllegalArgumentException;
    ...
    public static final class DataUriFetcher<Data> implements DataFetcher<Data> {
        ...
        public void loadData(Priority priority, DataFetcher.DataCallback<? super Data> dataCallback) {
            try {
                Data mo229decode = this.reader.mo229decode(this.dataUri);
                this.data = mo229decode;
                dataCallback.onDataReady(mo229decode);
    ...
    public static final class StreamFactory<Model> implements ModelLoaderFactory<Model, InputStream> {
        public final DataDecoder<InputStream> opener = new DataDecoder<InputStream>() { // from class: com.bumptech.glide.load.model.DataUrlLoader.StreamFactory.1
            ...
            /* renamed from: decode */
            public InputStream mo229decode(String str) {
