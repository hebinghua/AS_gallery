...
public class MediaEffect {
    ...
    public static native void SetExternalSourceJni(int i, int i2, byte[] bArr, int i3, long j);
    ...
    public static void SetExternalSource(int i, int i2, byte[] bArr, int i3, long j) {
        String str = TAG;
        Log.d(str, "SetExternalSource w:" + i + " h:" + i2 + " stride:" + i3 + " data len:" + bArr.length);
        SetExternalSourceJni(i, i2, bArr, i3, j);
    }
}
