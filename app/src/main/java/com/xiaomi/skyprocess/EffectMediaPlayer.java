...
public class EffectMediaPlayer {
    ...
    private static native void SetMediaFilterRenderPlayerCallbackJni(RenderPlayerNotifierCallBack renderPlayerNotifierCallBack);
    ...
    private static native void muteJni();

    private static native void unmuteJni();
    ...
    public void SetMediaFilterRenderPlayerCallback(RenderPlayerNotifierCallBack renderPlayerNotifierCallBack) {
        Log.d(TAG, "SetMediaFilterRenderPlayerCallbackJni");
        SetMediaFilterRenderPlayerCallbackJni(renderPlayerNotifierCallBack);
    }
}
