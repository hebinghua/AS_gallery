...
public abstract class BaseRenderDrawer {
    ...
    public abstract void onCroped(int i, int i2, int i3, int i4, int i5, int i6, int i7);
    ...
    public void cropSize(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        onCroped(i, i2, i3, i4, i5, i6, i7);
    }
