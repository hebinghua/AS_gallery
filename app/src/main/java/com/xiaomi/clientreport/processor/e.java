...
public class e {
    public static PerfClientReport a(PerfClientReport perfClientReport, String str) {
        long[] m1870a;
        if (perfClientReport == null || (m1870a = m1870a(str)) == null) {
            return null;
        }
        perfClientReport.perfCounts = m1870a[0];
        perfClientReport.perfLatencies = m1870a[1];
    ...
    public static PerfClientReport a(String str) {
        ...
        try {
            String[] m1871a = m1871a(str);
            if (m1871a == null || m1871a.length < 4 || TextUtils.isEmpty(m1871a[0]) || TextUtils.isEmpty(m1871a[1]) || TextUtils.isEmpty(m1871a[2]) || TextUtils.isEmpty(m1871a[3])) {
                return null;
            }
            perfClientReport = PerfClientReport.getBlankInstance();
            perfClientReport.production = Integer.parseInt(m1871a[0]);
            perfClientReport.clientInterfaceId = m1871a[1];
            perfClientReport.reportType = Integer.parseInt(m1871a[2]);
            perfClientReport.code = Integer.parseInt(m1871a[3]);
            return perfClientReport;
    ...
    public static HashMap<String, String> m1869a(String str) {
    ...
    */
    ...
    public static void a(String str, com.xiaomi.clientreport.data.a[] aVarArr) {
        ...
        try {
            ...
            HashMap<String, String> m1869a = m1869a(str);
    ...
    public static void a(HashMap<String, String> hashMap, String str, long j, long j2) {
        ...
        if (TextUtils.isEmpty(str2)) {
            ...
            long[] m1870a = m1870a(str2);
            if (m1870a == null || m1870a[0] <= 0 || m1870a[1] < 0) {
                sb = new StringBuilder();
            } else {
                j += m1870a[0];
                j2 += m1870a[1];
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static long[] m1870a(String str) {
