...
public class PushMessageHandler extends BaseService {
    ...
    public static ThreadPoolExecutor f36a = new ThreadPoolExecutor(1, 1, 15, TimeUnit.SECONDS, new LinkedBlockingQueue());
    ...
    public static void a(Context context, a aVar) {
        if (aVar instanceof MiPushMessage) {
            ...
            String str = null;
            if (ey.COMMAND_REGISTER.f318a.equals(command)) {
                List<String> commandArguments = miPushCommandMessage.getCommandArguments();
                if (commandArguments != null && !commandArguments.isEmpty()) {
                    str = commandArguments.get(0);
                }
                a(miPushCommandMessage.getResultCode(), miPushCommandMessage.getReason(), str);
            } else if (ey.COMMAND_SET_ALIAS.f318a.equals(command) || ey.COMMAND_UNSET_ALIAS.f318a.equals(command) || ey.COMMAND_SET_ACCEPT_TIME.f318a.equals(command)) {
                a(context, miPushCommandMessage.getCategory(), command, miPushCommandMessage.getResultCode(), miPushCommandMessage.getReason(), miPushCommandMessage.getCommandArguments());
            } else if (ey.COMMAND_SUBSCRIBE_TOPIC.f318a.equals(command)) {
            ...
            } else if (!ey.COMMAND_UNSUBSCRIBE_TOPIC.f318a.equals(command)) {
            } else {
    ...
    public static void b(Context context) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m1859a("callback sync error" + e);
        }
    }
    ...
    public static void b(Context context, Intent intent) {
        ...
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m1859a("intent unparcel error:" + th);
        }
        try {
