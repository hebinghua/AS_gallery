...
public class db {
                ...
                if (iuVar != null) {
                    try {
                        if (iuVar instanceof ia) {
                            String str = ((ia) iuVar).f574d;
                            if (!TextUtils.isEmpty(str) && en.a(en.m2125a(str)) != -1) {
                                a = en.a(en.m2125a(str));
                                break;
                            }
                        } else if (iuVar instanceof ii) {
                            String str2 = ((ii) iuVar).f633d;
                            if (!TextUtils.isEmpty(str2)) {
                                if (en.a(en.m2125a(str2)) != -1) {
                                    a = en.a(en.m2125a(str2));
                                }
                                if (ht.UploadTinyData.equals(en.m2125a(str2))) {
                                    return -1;
                                }
                            }
                        }
    ...
    public static void a(String str, Context context, byte[] bArr) {
        ...
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m1859a("fail to convert bytes to container");
        }
    }
}
