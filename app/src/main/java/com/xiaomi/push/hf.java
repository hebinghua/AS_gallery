...
public class hf {
    ...
    public static void a(Context context, hh hhVar, List<hn> list) {
        ...
        com.xiaomi.channel.commonutils.logger.b.m1859a("TinyData TinyDataCacheUploader.uploadTinyData itemsUploading == null || itemsUploading.size() == 0  ts:" + System.currentTimeMillis());
    }
