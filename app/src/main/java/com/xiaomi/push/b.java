...
public final class b {
    ...
    public String m1948a() {
        ...
        int i2 = this.c;
        if (d > i - i2 || d <= 0) {
            return new String(m1953a(d), Keyczar.DEFAULT_ENCODING);
        }
        String str = new String(this.f118a, i2, d, Keyczar.DEFAULT_ENCODING);
        this.c += d;
        return str;
    }
    ...
    public final boolean a(boolean z) {
        ...
        if (i >= i2) {
            ...
            this.e = i3 + i2;
            this.c = 0;
            InputStream inputStream = this.f117a;
            int read = inputStream == null ? -1 : inputStream.read(this.f118a);
            this.a = read;
            if (read == 0 || read < -1) {
    ...
    public byte[] m1953a(int i) {
        if (i >= 0) {
            ...
            if (i <= i6 - i3) {
                ...
                System.arraycopy(this.f118a, i3, bArr, 0, i);
                this.c += i;
                return bArr;
            } else if (i >= 4096) {
                this.e = i2 + i6;
                ...
                System.arraycopy(this.f118a, i3, bArr3, 0, i7);
                ...
                int i11 = i6 - i3;
                System.arraycopy(this.f118a, i3, bArr5, 0, i11);
                this.c = this.a;
                while (true) {
                    a(true);
                    int i12 = i - i11;
                    int i13 = this.a;
                    if (i12 <= i13) {
                        System.arraycopy(this.f118a, 0, bArr5, i11, i12);
                        this.c = i12;
                        return bArr5;
                    }
                    System.arraycopy(this.f118a, 0, bArr5, i11, i13);
                    int i14 = this.a;
                    i11 += i14;
                    this.c = i14;
                }
