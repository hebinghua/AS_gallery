...
public class gm extends gn {
    ...
    public gm(Bundle bundle) {
        ...
        this.f419b = bundle.getBoolean("ext_msg_encrypt", false);
    ...
    public Bundle mo2201a() {
        ...
        if (!TextUtils.isEmpty(this.b)) {
            mo2201a.putString("ext_msg_type", this.b);
        }
        String str = this.d;
        if (str != null) {
            mo2201a.putString("ext_msg_lang", str);
        }
        String str2 = this.e;
        if (str2 != null) {
            mo2201a.putString("ext_msg_sub", str2);
        }
        String str3 = this.f;
        if (str3 != null) {
            mo2201a.putString("ext_msg_body", str3);
        }
        if (!TextUtils.isEmpty(this.g)) {
            mo2201a.putString("ext_body_encode", this.g);
        }
        String str4 = this.c;
        if (str4 != null) {
            mo2201a.putString("ext_msg_thread", str4);
        }
        String str5 = this.h;
        if (str5 != null) {
            mo2201a.putString("ext_msg_appid", str5);
        }
        if (this.a) {
            mo2201a.putBoolean("ext_msg_trans", true);
        }
        if (!TextUtils.isEmpty(this.i)) {
            mo2201a.putString("ext_msg_seq", this.i);
        }
        if (!TextUtils.isEmpty(this.j)) {
            mo2201a.putString("ext_msg_mseq", this.j);
        }
        if (!TextUtils.isEmpty(this.k)) {
            mo2201a.putString("ext_msg_fseq", this.k);
        }
        if (this.f419b) {
            mo2201a.putBoolean("ext_msg_encrypt", true);
        }
        if (!TextUtils.isEmpty(this.l)) {
            mo2201a.putString("ext_msg_status", this.l);
        }
        return mo2201a;
    }
