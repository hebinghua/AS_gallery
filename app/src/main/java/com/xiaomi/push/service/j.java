...
public class j {
    ...
    public bg.b a(fl flVar) {
        Collection<bg.b> m2490a = bg.a().m2490a(Integer.toString(flVar.a()));
        if (m2490a.isEmpty()) {
            return null;
        }
        Iterator<bg.b> it = m2490a.iterator();
        if (m2490a.size() == 1) {
            return it.next();
        }
        String g = flVar.g();
        while (it.hasNext()) {
            bg.b next = it.next();
            if (TextUtils.equals(g, next.f916b)) {
                return next;
            }
        }
        return null;
    ...
    */
    public com.xiaomi.push.service.bg.b a(com.xiaomi.push.gn r6) {
        /*
            r5 = this;
            com.xiaomi.push.service.bg r0 = com.xiaomi.push.service.bg.a()
            java.lang.String r1 = r6.k()
            java.util.Collection r0 = r0.m2490a(r1)
    ...
    public void a(Context context) {
        ...
        if (com.xiaomi.push.m.m2404c()) {
            intent.addFlags(nexEngine.ExportHEVCMainTierLevel62);
        }
        com.xiaomi.channel.commonutils.logger.b.m1859a("[Bcst] send ***.push.service_started broadcast to inform push service has started.");
        context.sendBroadcast(intent);
    }
    ...
    public void a(Context context, bg.b bVar, int i) {
        ...
        intent.setPackage(bVar.f913a);
        intent.putExtra(bk.t, bVar.g);
        intent.putExtra("ext_reason", i);
        intent.putExtra(bk.q, bVar.f916b);
        intent.putExtra(bk.F, bVar.i);
        if (bVar.f907a == null || !"9".equals(bVar.g)) {
            com.xiaomi.channel.commonutils.logger.b.m1859a(String.format("[Bcst] notify channel closed. %s,%s,%d", bVar.g, bVar.f913a, Integer.valueOf(i)));
            a(context, intent, bVar);
            return;
        }
        try {
            bVar.f907a.send(Message.obtain(null, 17, intent));
        } catch (RemoteException unused) {
            bVar.f907a = null;
            StringBuilder sb = new StringBuilder();
            sb.append("peer may died: ");
            String str = bVar.f916b;
    ...
    public void a(Context context, bg.b bVar, String str, String str2) {
        if (bVar == null) {
            ...
            intent.putExtra(bk.q, bVar.f916b);
            intent.putExtra(bk.F, bVar.i);
            com.xiaomi.channel.commonutils.logger.b.m1859a(String.format("[Bcst] notify packet(blob) arrival. %s,%s,%s", bVar.g, bVar.f913a, str2));
            a(context, intent, bVar);
        }
    }
    ...
    public void a(Context context, bg.b bVar, boolean z, int i, String str) {
        ...
        intent.putExtra(bk.q, bVar.f916b);
        intent.putExtra(bk.F, bVar.i);
        com.xiaomi.channel.commonutils.logger.b.m1859a(String.format("[Bcst] notify channel open result. %s,%s,%b,%d", bVar.g, bVar.f913a, Boolean.valueOf(z), Integer.valueOf(i)));
        a(context, intent, bVar);
    }
    ...
    public void a(XMPushService xMPushService, String str, fl flVar) {
        ...
        if (a == null) {
            ...
            intent.putExtra("ext_raw_packet", flVar.m2163a(a.h));
            intent.putExtra(bk.F, a.i);
            intent.putExtra(bk.x, a.h);
            if (a.f907a != null) {
                try {
                    a.f907a.send(Message.obtain(null, 17, intent));
                    com.xiaomi.channel.commonutils.logger.b.m1859a("message was sent by messenger for chid=" + str);
                    return;
                } catch (RemoteException unused) {
                    a.f907a = null;
                    StringBuilder sb = new StringBuilder();
            ...
            if (com.xiaomi.stat.c.c.a.equals(str2)) {
                return;
            }
            com.xiaomi.channel.commonutils.logger.b.m1859a(String.format("[Bcst] notify packet(blob) arrival. %s,%s,%s", a.g, a.f913a, flVar.e()));
            a(xMPushService, intent, a);
            if (!"10".equals(str) || (aoVar = flVar.f357a) == null) {
                return;
            }
            ...
            bz.a("category_coord_down", "coord_down", com.xiaomi.stat.c.c.a, flVar.f357a);
        }
    }
    ...
    public void a(XMPushService xMPushService, String str, gn gnVar) {
        ...
        if (a != null) {
            ...
            intent.putExtra("ext_chid", str);
            intent.putExtra("ext_packet", gnVar.mo2201a());
            intent.putExtra(bk.F, a.i);
            intent.putExtra(bk.x, a.h);
            com.xiaomi.channel.commonutils.logger.b.m1859a(String.format("[Bcst] notify packet arrival. %s,%s,%s", a.g, a.f913a, gnVar.j()));
            a(xMPushService, intent, a);
            return;
        }
