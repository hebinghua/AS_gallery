...
public class x {
    ...
    public static final Map<String, byte[]> f989a = new HashMap();
    public static ArrayList<Pair<String, byte[]>> a = new ArrayList<>();

    public static void a(Context context, int i, String str) {
        Map<String, byte[]> map = f989a;
        synchronized (map) {
            for (String str2 : map.keySet()) {
                com.xiaomi.channel.commonutils.logger.b.m1859a("notify registration error. " + str2);
                a(context, str2, f989a.get(str2), i, str);
            }
            f989a.clear();
        }
    }
        ...
        try {
            ...
            synchronized (map) {
                for (String str : map.keySet()) {
                    com.xiaomi.channel.commonutils.logger.b.m1859a("processing pending registration request. " + str);
                    ah.a(xMPushService, str, f989a.get(str));
    ...
    public static void a(String str, byte[] bArr) {
        Map<String, byte[]> map = f989a;
        synchronized (map) {
            com.xiaomi.channel.commonutils.logger.b.m1859a("pending registration request. " + str);
            map.put(str, bArr);
        }
    }
