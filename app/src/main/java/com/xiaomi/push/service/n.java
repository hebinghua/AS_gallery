...
public class n {
    ...
    public static void a(Context context, Intent intent) {
        ...
        try {
            ...
            if (b != null) {
                al.m2459a(context, y.a(b), b);
            } else {
                com.xiaomi.channel.commonutils.logger.b.m1859a("notify fcm notification error ：dencrypt failed");
            }
        } catch (Throwable th) {
    ...
    public static byte[] b(byte[] bArr, String str) {
        if (TextUtils.isEmpty(str)) {
            com.xiaomi.channel.commonutils.logger.b.m1859a("secret is empty, return null");
            return null;
        }
        try {
            return com.xiaomi.push.i.a(com.xiaomi.push.bm.m1977a(str), bArr);
        } catch (Exception e) {
