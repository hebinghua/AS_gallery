...
public class bb {
        ...
        for (hu huVar : list) {
            ...
            if (a2 != null) {
                if (!z || !huVar.f495a) {
                    ...
                    arrayList.add(i != 1 ? i != 2 ? i != 3 ? i != 4 ? null : new Pair(Integer.valueOf(a), Boolean.valueOf(huVar.g())) : new Pair(Integer.valueOf(a), huVar.m2245a()) : new Pair(Integer.valueOf(a), Long.valueOf(huVar.m2244a())) : new Pair(Integer.valueOf(a), Integer.valueOf(huVar.c())));
                } else {
    ...
    public static void a(ba baVar, ih ihVar) {
        ...
        for (hs hsVar : ihVar.a()) {
            arrayList.add(new Pair<>(hsVar.m2240a(), Integer.valueOf(hsVar.a())));
            List<Pair<Integer, Object>> a = a(hsVar.f487a, false);
