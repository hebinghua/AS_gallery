...
public class bz {
    ...
    /* renamed from: a  reason: collision with other field name */
    public static AtomicLong f941a = new AtomicLong(0);
    ...
    public static ii a(String str, String str2, hm hmVar) {
        return new ii("-1", false).d(str).b(str2).a(com.xiaomi.push.ab.a(it.a(hmVar))).c(ht.UploadTinyData.f489a);
    }
    ...
    */
    ...
    public static void a(String str, String str2, String str3, ao aoVar) {
        ...
        hashMap.put("screen_on", String.valueOf(aoVar.f881a));
        hashMap.put("wifi", String.valueOf(aoVar.f883b));
        hashMap.put("rx_msg", String.valueOf(aoVar.f880a));
        hashMap.put("enqueue", String.valueOf(aoVar.f882b));
    ...
    public static boolean a(hn hnVar, boolean z) {
        ...
        } else if (!z && TextUtils.isEmpty(hnVar.f461a)) {
            str = "item.channel is null or empty, verfiy ClientUploadDataItem failed.";
        } else if (TextUtils.isEmpty(hnVar.f468d)) {
            str = "item.category is null or empty, verfiy ClientUploadDataItem failed.";
        } else if (TextUtils.isEmpty(hnVar.f467c)) {
            str = "item.name is null or empty, verfiy ClientUploadDataItem failed.";
        } else if (!com.xiaomi.push.bp.m1979a(hnVar.f468d)) {
            str = "item.category can only contain ascii char, verfiy ClientUploadDataItem failed.";
        } else if (!com.xiaomi.push.bp.m1979a(hnVar.f467c)) {
            str = "item.name can only contain ascii char, verfiy ClientUploadDataItem failed.";
        } else {
            String str2 = hnVar.f466b;
            if (str2 == null || str2.length() <= 10240) {
                return false;
            }
            str = "item.data is too large(" + hnVar.f466b.length() + "), max size for data is 10240 , verfiy ClientUploadDataItem failed.";
        }
    ...
    public static boolean a(String str) {
        return !com.xiaomi.push.v.m2555b() || "com.miui.hybrid".equals(str);
    }
}
