...
public class e {
    ...
    public static final int[] f958a = {1, 2, 4, 8, 16};
    ...
    public static void a(Context context, String str) {
        List<NotificationChannel> m2481a;
        if (!com.xiaomi.push.m.m2400a(context) || TextUtils.isEmpty(str) || (m2481a = ax.a(context, str).m2481a()) == null) {
            return;
        }
        synchronized (e.class) {
            SharedPreferences a2 = a(context);
            ArrayList arrayList = new ArrayList();
            for (NotificationChannel notificationChannel : m2481a) {
    ...
    public static void a(Context context, String str, String str2, int i, String str3, boolean z, int i2) {
        if (!com.xiaomi.push.m.m2400a(context) || TextUtils.isEmpty(str3) || TextUtils.isEmpty(str2) || TextUtils.isEmpty(str)) {
            if (!com.xiaomi.push.m.m2400a(context)) {
                return;
            }
            com.xiaomi.channel.commonutils.logger.b.m1859a("ChannelPC: can`t setup permission with permissionCode:" + String.valueOf(str3) + " channelId:" + String.valueOf(str2) + " targetPkg:" + str);
            return;
        }
    ...
    public static void a(String str, String str2, int i, int i2) {
        ...
        for (int i3 : f958a) {
            if ((b.get(i3).intValue() & i2) == 0) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m1859a("ChannelPermissions.grantPermission:" + str + ":" + str2 + ": <" + i3 + "> :stoped by userLock");
            }
        }
    }

    public static void a(String str, String str2, int i, boolean z) {
        boolean a2 = ay.a(com.xiaomi.push.v.m2551a(), str, str2, a.get(i), z);
        com.xiaomi.channel.commonutils.logger.b.m1859a("ChannelPermissions.grantPermission:" + str + ":" + str2 + ": <" + i + "=" + z + "> :" + a2);
    }
    ...
    public static boolean a(String str, String str2, int i) {
        boolean z = true;
        if (ay.a(com.xiaomi.push.v.m2551a(), str, str2, a.get(i)) != 1) {
            z = false;
        }
        com.xiaomi.channel.commonutils.logger.b.m1859a("ChannelPermissions.checkPermission:" + str + ":" + str2 + ": <" + i + "=" + z + ">");
        return z;
    }
}
