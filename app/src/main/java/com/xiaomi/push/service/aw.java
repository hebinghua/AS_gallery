...
public class aw {
    ...
    public static int a(Context context, InputStream inputStream) {
        ...
        if (options.outWidth == -1 || options.outHeight == -1) {
            com.xiaomi.channel.commonutils.logger.b.m1859a("decode dimension failed for bitmap.");
            return 1;
        }
    ...
    */
    public static com.xiaomi.push.service.aw.a a(java.lang.String r10, boolean r11) {
        /*
            ...
            if (bArr != null) {
                if (z) {
                    ...
                    try {
                        ...
                        bVar.f891a = BitmapFactory.decodeByteArray(bArr, 0, bArr.length, options);
                    ...
                    bVar.f891a = BitmapFactory.decodeByteArray(bArr, 0, bArr.length);
                }
            }
            a(context, a2.f890a, str);
            com.xiaomi.push.ab.a(byteArrayInputStream);
            return bVar;
        } catch (Throwable th2) {
            th = th2;
    ...
    */
    public static void a(android.content.Context r5, byte[] r6, java.lang.String r7) {
        /*
            ...
            com.xiaomi.channel.commonutils.logger.b.m1859a(r5)
            return
        L8:
            a(r5)
