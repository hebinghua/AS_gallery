...
public final class OExtendedStorageOperator extends AbsExtendedStorageOperator {
    ...
    public OExtendedStorageOperator(Context context, IStorageStrategyHolder holder) {
        super(context, holder);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(holder, "holder");
        this.holder = holder;
        this.moveActions = CollectionsKt__CollectionsKt.listOf((Object[]) new Function1[]{new OExtendedStorageOperator$moveActions$1(this), new OExtendedStorageOperator$moveActions$2(this), new OExtendedStorageOperator$moveActions$3(this)});
    }
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (!documentFile.delete()) {
                                        DefaultLogger.w("OExtendedStorageOperator", "transfer success but delete src file error.");
                                    }
                                    if ((!apply(documentFile2)) | (!apply(documentFile))) {
                                        DefaultLogger.w("OExtendedStorageOperator", "transfer success but apply error.");
                                    }
                                    ...
                                    try {
                                        DefaultLogger.e("OExtendedStorageOperator", "move file [%s] -> [%s] by channel failed, error: %s", str, str2, e);
                                        BaseMiscUtil.closeSilently(fileChannel2);
