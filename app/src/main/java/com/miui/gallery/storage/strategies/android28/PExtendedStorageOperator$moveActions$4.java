...
public final class PExtendedStorageOperator$moveActions$4 extends Lambda implements Function1<Triple<? extends String, ? extends String, ? extends String>, Boolean> {
    public final /* synthetic */ PExtendedStorageOperator this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PExtendedStorageOperator$moveActions$4(PExtendedStorageOperator pExtendedStorageOperator) {
        super(1);
