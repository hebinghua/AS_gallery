...
public final class OExtendedStorageOperator$moveActions$3 extends Lambda implements Function1<Triple<? extends String, ? extends String, ? extends String>, Boolean> {
    public final /* synthetic */ OExtendedStorageOperator this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OExtendedStorageOperator$moveActions$3(OExtendedStorageOperator oExtendedStorageOperator) {
        super(1);
