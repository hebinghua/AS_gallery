...
public class MIUIFileApiStorageStrategy extends FileApiStorageStrategy {
    public static final LazyValue<Void, Boolean> HAS_MIUI_HACKED = new LazyValue<Void, Boolean>() { // from class: com.miui.gallery.storage.strategies.android28.MIUIFileApiStorageStrategy.1
