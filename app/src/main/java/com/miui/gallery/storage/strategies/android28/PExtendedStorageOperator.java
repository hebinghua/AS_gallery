...
public final class PExtendedStorageOperator extends AbsExtendedStorageOperator {
    ...
    public PExtendedStorageOperator(Context context, IStorageStrategyHolder holder) {
        super(context, holder);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(holder, "holder");
        this.holder = holder;
        this.moveActions = CollectionsKt__CollectionsKt.listOf((Object[]) new Function1[]{new PExtendedStorageOperator$moveActions$1(this), new PExtendedStorageOperator$moveActions$2(this), new PExtendedStorageOperator$moveActions$3(this), new PExtendedStorageOperator$moveActions$4(this)});
    }
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (!documentFile.delete()) {
                                        DefaultLogger.w("PExtendedStorageOperator", "transfer success but delete src file error.");
                                    }
                                    if ((!apply(documentFile2)) | (!apply(documentFile))) {
                                        DefaultLogger.w("PExtendedStorageOperator", "transfer success but apply error.");
                                    }
                                    ...
                                    try {
                                        DefaultLogger.e("PExtendedStorageOperator", "move file [%s] -> [%s] by channel failed, error: %s", str, str2, e);
                                        BaseMiscUtil.closeSilently(fileChannel2);
