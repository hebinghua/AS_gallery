...
public final class RExtendedStorageOperator$moveActions$4 extends Lambda implements Function1<Triple<? extends String, ? extends String, ? extends String>, Boolean> {
    public final /* synthetic */ RExtendedStorageOperator this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RExtendedStorageOperator$moveActions$4(RExtendedStorageOperator rExtendedStorageOperator) {
        super(1);
    ...
    public final Boolean invoke2(Triple<String, String, String> params) {
        ...
        moveFileInner4 = this.this$0.moveFileInner4(params.getFirst(), params.getSecond(), params.getThird());
