...
public final class RExtendedStorageOperator$moveActions$1 extends Lambda implements Function1<Triple<? extends String, ? extends String, ? extends String>, Boolean> {
    public final /* synthetic */ RExtendedStorageOperator this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RExtendedStorageOperator$moveActions$1(RExtendedStorageOperator rExtendedStorageOperator) {
        super(1);
