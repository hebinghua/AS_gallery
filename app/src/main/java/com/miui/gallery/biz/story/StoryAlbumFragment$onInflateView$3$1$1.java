...
public final class StoryAlbumFragment$onInflateView$3$1$1 extends Lambda implements Function1<ImageLoadParams.Builder, Unit> {
    public final /* synthetic */ int $position;
    public final /* synthetic */ StoryAlbumFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoryAlbumFragment$onInflateView$3$1$1(StoryAlbumFragment storyAlbumFragment, int i) {
        super(1);
    ...
    public final void invoke2(ImageLoadParams.Builder ImageLoadParams) {
        ...
        ImageLoadParams.m1104setKey(storyAlbumAdapter.getItemId(this.$position));
        storyAlbumAdapter2 = this.this$0.adapter;
        if (storyAlbumAdapter2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapter");
            storyAlbumAdapter2 = null;
        }
        ImageLoadParams.m1100setFilePath(storyAlbumAdapter2.getBindImagePath(this.$position));
        ...
        ImageLoadParams.m1107setRegionRect(storyAlbumAdapter3.getItemDecodeRectF(this.$position));
        ...
        ImageLoadParams.m1106setMimeType(storyAlbumAdapter4.getMimeType(this.$position));
        storyAlbumAdapter5 = this.this$0.adapter;
        if (storyAlbumAdapter5 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapter");
            storyAlbumAdapter5 = null;
        }
        ImageLoadParams.m1099setFileLength(storyAlbumAdapter5.getFileLength(this.$position));
        storyAlbumAdapter6 = this.this$0.adapter;
        if (storyAlbumAdapter6 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapter");
            storyAlbumAdapter6 = null;
        }
        ImageLoadParams.m1098setCreateTime(storyAlbumAdapter6.getCreateTime(this.$position));
        ...
        ImageLoadParams.m1105setLocation(storyAlbumAdapter8.getLocation(this.$position));
    }
}
