...
import com.miui.gallery.arch.platform.BaseUIFragment;
...
public abstract class Hilt_AlbumPermissionFragment<VM extends BaseViewModel> extends BaseUIFragment<VM> implements GeneratedComponentManager {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AlbumPermissionFragment_GeneratedInjector) mo2560generatedComponent()).injectAlbumPermissionFragment((AlbumPermissionFragment) UnsafeCasts.unsafeCast(this));
        }
    }
