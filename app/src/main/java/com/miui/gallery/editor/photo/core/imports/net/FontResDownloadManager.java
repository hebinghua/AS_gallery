...
public class FontResDownloadManager {
    ...
    public void download(LocalResource localResource, String str, final Request.Listener listener, final boolean z) {
        long j = localResource.id;
        ...
        downloadRequest.execute(new ResponseListener() { // from class: com.miui.gallery.editor.photo.core.imports.net.FontResDownloadManager.1
