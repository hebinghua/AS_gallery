...
public abstract class DialogSubMenuOld<T, E> {
    public T mListener;
    ...
    public DialogSubMenuOld(Context context, ViewGroup viewGroup, int i, int i2) {
    ...
    public final View initNavigationRadioButton(Context context) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.text_edit_dialog_navigation_button_old, (ViewGroup) null);
        TextView textView = (TextView) inflate.findViewById(R.id.text_edit_dialog_navigation_button);
        this.mRadioButton = textView;
        textView.setCompoundDrawablesWithIntrinsicBounds(context.getResources().getDrawable(this.mNavigationDrawableRes), (Drawable) null, (Drawable) null, (Drawable) null);
