...
public class MosaicEntityTriangleRect extends MosaicEntityRely {
    ...
    public MosaicShaderHolder generateShader(Bitmap bitmap, float f, Matrix matrix) {
        ...
        DefaultLogger.d("MosaicEntityTriangleRect", "allocate cache costs %dms", Long.valueOf(System.currentTimeMillis() - currentTimeMillis));
        int i2 = 0;
        ...
        DefaultLogger.d("MosaicEntityTriangleRect", "init cache costs %dms", Long.valueOf(System.currentTimeMillis() - currentTimeMillis));
        ...
        DefaultLogger.d("MosaicEntityTriangleRect", "generate pixels costs %dms", Long.valueOf(System.currentTimeMillis() - currentTimeMillis));
        Bitmap createBitmap = Bitmap.createBitmap(iArr3, bitmap.getWidth(), bitmap.getHeight(), Bitmap.Config.ARGB_8888);
        DefaultLogger.d("MosaicEntityTriangleRect", "finish costs %dms", Long.valueOf(System.currentTimeMillis() - currentTimeMillis));
