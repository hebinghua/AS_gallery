...
public class AlbumShareState {
    public static final int[] NEGATIVE_NEXT = {-1, 0, 4, 2, 2, 6, 5};
    public static final int[] POSITIVE_NEXT = {1, 2, 3, 5, -1, -1, -1};
    public static final StateValue[] STATE_VALUE_ARR = {new StateValue("invited", null, 0), new StateValue("invited", "requesting", 0), new StateValue("invited", null, 1), new StateValue("invited", "accepting", 1), new StateValue("invited", "denying", 1), new StateValue("normal", null, 2), new StateValue("normal", "exiting", 2)};
    ...
    public static int getState(String str, String str2, boolean z) {
        ...
        for (StateValue stateValue : STATE_VALUE_ARR) {
            if (TextUtils.equals(stateValue.mDBState, str) && TextUtils.equals(stateValue.mUIState, str2)) {
                int i2 = stateValue.mShareDetailInfoRequest;
                if (i2 != 2) {
                    boolean z2 = true;
                    if (i2 != 1) {
                        z2 = false;
