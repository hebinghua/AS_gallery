...
public class CopyShareMediaToOwnerAlbum extends BaseCopy {
    ...
    public CopyShareMediaToOwnerAlbum(Context context, ArrayList<Long> arrayList, long j, long j2, Cursor cursor) {
    ...
    public void buildValues(boolean z) {
        ...
        this.mValues.put("localFlag", Integer.valueOf(z ? -2 : 9));
        ...
        this.mValues.put("localImageId", Long.valueOf(ShareMediaManager.getOriginalMediaId(this.mMediaId)));
    }
    ...
    public long execute(SupportSQLiteDatabase supportSQLiteDatabase, MediaManager mediaManager) {
        ...
        try {
            DefaultLogger.d("galleryAction_Method_AddToAlbum", "COPY (CopyShareMediaToOwnerAlbum) => inserts : %s", Util.desensitization(this.mValues));
            long insert = supportSQLiteDatabase.insert("cloud", 0, this.mValues);
            DefaultLogger.d("galleryAction_Method_AddToAlbum", "COPY (CopyShareMediaToOwnerAlbum) => inserts finish id [%d]", Long.valueOf(insert));
