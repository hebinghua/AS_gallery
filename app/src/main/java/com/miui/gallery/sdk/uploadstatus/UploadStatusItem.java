...
public class UploadStatusItem extends SyncItem {
    ...
    public int hashCode() {
        return Objects.hash(this.mItemType, this.mLocalId);
    }

    public String toString() {
        return String.format("[mItemType: %s, mLocalId: %s, mStatus: %s]", this.mItemType.toString(), this.mLocalId, this.mStatus.toString());
    }
}
