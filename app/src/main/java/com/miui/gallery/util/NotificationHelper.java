...
public class NotificationHelper {
    public static int getBabyAlbumNotificationId(boolean z, int i) {
        if (z) {
            return (i % nexCrop.ABSTRACT_DIMENSION) + 200000;
        }
        return (i % nexCrop.ABSTRACT_DIMENSION) + nexCrop.ABSTRACT_DIMENSION;
    }
    ...
    public static void addNotificationChannel(Context context, int i) {
