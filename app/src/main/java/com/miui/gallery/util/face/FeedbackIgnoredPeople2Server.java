...
public class FeedbackIgnoredPeople2Server {
    ...
    public static void doFeedback(Context context, Account account, GalleryExtendedAuthToken galleryExtendedAuthToken, String str, ArrayList<String> arrayList) throws Exception {
