...
public class ArtStillLibraryLoaderHelper extends LibraryLoaderHelper {
    ...
    public static LibraryLoaderHelper getInstance() {
        if (sInstance == null) {
            sInstance = new ArtStillLibraryLoaderHelper();
        }
        return sInstance;
    }
    ...
    public void showNoNetworkToast() {
        ToastUtils.makeText(GalleryApp.sGetAndroidContext(), (int) R.string.art_still_download_failed_for_notwork);
    }
    ...
    public void showConfirmDownloadDialog(FragmentActivity fragmentActivity, final Library library, final LibraryLoaderHelper.DownloadStartListener downloadStartListener) {
        NetworkConsider.consider(fragmentActivity, new NetworkConsider.OnConfirmed() { // from class: com.miui.gallery.util.ArtStillLibraryLoaderHelper$$ExternalSyntheticLambda0
            @Override // com.miui.gallery.ui.NetworkConsider.OnConfirmed
            public final void onConfirmed(boolean z, boolean z2) {
                ArtStillLibraryLoaderHelper.this.lambda$showConfirmDownloadDialog$0(library, downloadStartListener, z, z2);
            }
        });
    }
