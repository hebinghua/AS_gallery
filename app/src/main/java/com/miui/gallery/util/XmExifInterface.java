...
public class XmExifInterface {
    ...
    public static final byte[] IDENTIFIER_XIAOMI_APP;
    ...
    public static final boolean DEBUG = Log.isLoggable("XmExifInterface", 3);
    ...
    static {
        ...
        IDENTIFIER_XIAOMI_APP = "XMTH".getBytes(forName);
    ...
    public static class ExifAttribute {
        ...
        public static ExifAttribute createUShort(int[] iArr, ByteOrder byteOrder) {
            ByteBuffer wrap = ByteBuffer.wrap(new byte[XmExifInterface.IFD_FORMAT_BYTES_PER_FORMAT[3] * iArr.length]);
        ...
        public static ExifAttribute createULong(long[] jArr, ByteOrder byteOrder) {
            ByteBuffer wrap = ByteBuffer.wrap(new byte[XmExifInterface.IFD_FORMAT_BYTES_PER_FORMAT[4] * jArr.length]);
            wrap.order(byteOrder);
            for (long j : jArr) {
                wrap.putInt((int) j);
            }
        ...
        public static ExifAttribute createString(String str) {
            byte[] bytes = (str + (char) 0).getBytes(XmExifInterface.ASCII);
            return new ExifAttribute(2, bytes.length, bytes);
        }

        public static ExifAttribute createURational(Rational[] rationalArr, ByteOrder byteOrder) {
            ByteBuffer wrap = ByteBuffer.wrap(new byte[XmExifInterface.IFD_FORMAT_BYTES_PER_FORMAT[5] * rationalArr.length]);
            wrap.order(byteOrder);
        ...
        public String toString() {
            return "(" + XmExifInterface.IFD_FORMAT_NAMES[this.format] + ", data length:" + this.bytes.length + ")";
        }
        ...
        */
        public java.lang.Object getValue(java.nio.ByteOrder r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.miui.gallery.util.XmExifInterface.ExifAttribute.getValue(java.nio.ByteOrder):java.lang.Object");
        }
    ...
    public XmExifInterface(String str) throws IOException {
    ...
    public XmExifInterface(InputStream inputStream) throws IOException {
        this(inputStream, false);
    }

    public XmExifInterface(InputStream inputStream, boolean z) throws IOException {
        ExifTag[][] exifTagArr = EXIF_TAGS;
        this.mAttributes = new HashMap[exifTagArr.length];
        this.mAttributesOffsets = new HashSet(exifTagArr.length);
        this.mExifByteOrder = ByteOrder.BIG_ENDIAN;
        ...
        if (z) {
            ...
            if (!isExifDataOnly(bufferedInputStream)) {
                Log.w("XmExifInterface", "Given data does not follow the structure of an Exif-only data.");
                return;
            }
    ...
    public final ExifAttribute getExifAttribute(String str) {
        ...
        if ("ISOSpeedRatings".equals(str)) {
            if (DEBUG) {
                Log.d("XmExifInterface", "getExifAttribute: Replacing TAG_ISO_SPEED_RATINGS with TAG_PHOTOGRAPHIC_SENSITIVITY.");
            }
    ...
    public String getAttribute(String str) {
        ...
        if (exifAttribute != null) {
            ...
            if (str.equals("GPSTimeStamp")) {
                ...
                if (i != 5 && i != 10) {
                    Log.w("XmExifInterface", "GPS Timestamp format is not rational. format=" + exifAttribute.format);
                    return null;
                }
                Rational[] rationalArr = (Rational[]) exifAttribute.getValue(this.mExifByteOrder);
                if (rationalArr == null || rationalArr.length != 3) {
                    Log.w("XmExifInterface", "Invalid GPS Timestamp array. array=" + Arrays.toString(rationalArr));
                    return null;
                }
        ...
        for (int i = 0; i < EXIF_TAGS.length; i++) {
            try {
                try {
                    ...
                    boolean z = DEBUG;
                    if (z) {
                        Log.w("XmExifInterface", "Invalid image: ExifInterface got an unsupported image format file(ExifInterface supports JPEG and some RAW image formats only) or a corrupted JPEG file to ExifInterface.", e);
                    }
    ...
    public static boolean isSeekableFD(FileDescriptor fileDescriptor) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                ...
                if (DEBUG) {
                    Log.d("XmExifInterface", "The file descriptor for the given input is not seekable");
                }
            }
        }
        return false;
    ...
    public final void printAttributes() {
        for (int i = 0; i < this.mAttributes.length; i++) {
            Log.d("XmExifInterface", "The size of tag group[" + i + "]: " + this.mAttributes[i].size());
            for (Map.Entry<String, ExifAttribute> entry : this.mAttributes[i].entrySet()) {
                ExifAttribute value = entry.getValue();
                Log.d("XmExifInterface", "tagName: " + entry.getKey() + ", tagType: " + value.toString() + ", tagValue: '" + value.getStringValue(this.mExifByteOrder) + "'");
            }
        }
    }
    ...
    public final boolean isHeifFormat(byte[] bArr) throws IOException {
        ...
        try {
            ...
            if (DEBUG) {
                Log.d("XmExifInterface", "Exception parsing HEIF file type box.", e);
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x00d5 A[FALL_THROUGH] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void getJpegAttributes(com.miui.gallery.util.XmExifInterface.ByteOrderedDataInputStream r23, int r24, int r25) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 594
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.miui.gallery.util.XmExifInterface.getJpegAttributes(com.miui.gallery.util.XmExifInterface$ByteOrderedDataInputStream, int, int):void");
    }
    ...
    public final void getRafAttributes(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        if (DEBUG) {
            Log.d("XmExifInterface", "numberOfDirectoryEntry: " + readInt);
        }
        for (int i3 = 0; i3 < readInt; i3++) {
            ...
            if (readUnsignedShort == TAG_RAF_IMAGE_SIZE.number) {
                ...
                Log.d("XmExifInterface", "Updated to length: " + ((int) readShort) + ", width: " + ((int) readShort2));
                return;
            }
    ...
    public final void getHeifAttributes(final ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 23) {
                mediaMetadataRetriever.setDataSource(new MediaDataSource() { // from class: com.miui.gallery.util.XmExifInterface.1
            ...
            if (extractMetadata != null && extractMetadata2 != null) {
                ...
                this.mExifBytes = bArr3;
                System.arraycopy(bArr, 0, bArr3, 0, 6);
                System.arraycopy(bArr2, 0, this.mExifBytes, 6, i3);
                readExifSegment(bArr2, 0);
            }
            if (DEBUG) {
                Log.d("XmExifInterface", "Heif meta: " + str4 + "x" + str + ", rotation " + str2);
            }
        } finally {
    ...
    /* JADX WARN: Removed duplicated region for block: B:54:0x0120 A[Catch: IOException -> 0x011c, TRY_LEAVE, TryCatch #8 {IOException -> 0x011c, blocks: (B:50:0x0118, B:54:0x0120), top: B:80:0x0118 }] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public byte[] getXmThumbnail() {
        /*
            Method dump skipped, instructions count: 320
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.miui.gallery.util.XmExifInterface.getXmThumbnail():byte[]");
    }
    ...
    public final void getOrfAttributes(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        if (exifAttribute != null) {
            ...
            if (iArr == null || iArr.length != 4) {
                Log.w("XmExifInterface", "Invalid aspect frame values. frame=" + Arrays.toString(iArr));
    ...
    public final void getPngAttributes(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        if (DEBUG) {
            Log.d("XmExifInterface", "getPngAttributes starting with: " + byteOrderedDataInputStream);
        }
        byteOrderedDataInputStream.setByteOrder(ByteOrder.BIG_ENDIAN);
    ...
    public final void getWebpAttributes(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        if (DEBUG) {
            Log.d("XmExifInterface", "getWebpAttributes starting with: " + byteOrderedDataInputStream);
        }
    ...
    public final ByteOrder readByteOrder(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        if (readShort == 18761) {
            if (DEBUG) {
                Log.d("XmExifInterface", "readExifSegment: Byte Align II");
            }
            return ByteOrder.LITTLE_ENDIAN;
        } else if (readShort == 19789) {
            if (DEBUG) {
                Log.d("XmExifInterface", "readExifSegment: Byte Align MM");
            }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void readImageFileDirectory(com.miui.gallery.util.XmExifInterface.ByteOrderedDataInputStream r31, int r32) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 1040
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.miui.gallery.util.XmExifInterface.readImageFileDirectory(com.miui.gallery.util.XmExifInterface$ByteOrderedDataInputStream, int):void");
    }
    ...
    public final void handleThumbnailFromJfif(ByteOrderedDataInputStream byteOrderedDataInputStream, HashMap hashMap) throws IOException {
        ...
        Log.d("XmExifInterface", "Setting thumbnail attributes with offset: " + intValue + ", length: " + min);
    }
    ...
    public final void handleThumbnailFromStrips(ByteOrderedDataInputStream byteOrderedDataInputStream, HashMap hashMap) throws IOException {
        ...
        if (convertToLongArray == null || convertToLongArray.length == 0) {
            Log.w("XmExifInterface", "stripOffsets should not be null or have zero length.");
        } else if (convertToLongArray2 == null || convertToLongArray2.length == 0) {
            Log.w("XmExifInterface", "stripByteCounts should not be null or have zero length.");
        } else if (convertToLongArray.length != convertToLongArray2.length) {
            Log.w("XmExifInterface", "stripOffsets and stripByteCounts should have same length.");
        } else {
            long j = 0;
            ...
            for (int i4 = 0; i4 < convertToLongArray.length; i4++) {
                ...
                int i7 = i5 - i2;
                if (i7 < 0) {
                    Log.d("XmExifInterface", "Invalid strip offset value");
                }
    ...
    public final boolean isSupportedDataType(HashMap hashMap) throws IOException {
        ...
        if (DEBUG) {
            Log.d("XmExifInterface", "Unsupported data type value");
            return false;
        }
        return false;
    }
    ...
    public final void validateImages() throws IOException {
        ...
        if (!isThumbnail(this.mAttributes[4])) {
            Log.d("XmExifInterface", "No image meets the size requirements of a thumbnail image.");
        }
    }
    ...
    public final void updateImageSizeValues(ByteOrderedDataInputStream byteOrderedDataInputStream, int i) throws IOException {
        ...
        if (exifAttribute.format == 5) {
            ...
            if (rationalArr == null || rationalArr.length != 2) {
                Log.w("XmExifInterface", "Invalid crop size values. cropSize=" + Arrays.toString(rationalArr));
                return;
            }
            ...
            if (iArr == null || iArr.length != 2) {
                Log.w("XmExifInterface", "Invalid crop size values. cropSize=" + Arrays.toString(iArr));
                return;
            }
    ...
    public static class ByteOrderedDataInputStream extends InputStream implements DataInput {
        ...
        public String readLine() throws IOException {
            Log.d("XmExifInterface", "Currently unsupported");
            return null;
        }
    ...
    public final void swapBasedOnImageSize(int i, int i2) throws IOException {
        if (this.mAttributes[i].isEmpty() || this.mAttributes[i2].isEmpty()) {
            ...
            Log.d("XmExifInterface", "Cannot perform swap since only one image data exists");
            return;
        }
        ...
        if (exifAttribute == null || exifAttribute2 == null) {
            ...
            Log.d("XmExifInterface", "First image does not contain valid size information");
        } else if (exifAttribute3 == null || exifAttribute4 == null) {
            if (!DEBUG) {
                return;
            }
            Log.d("XmExifInterface", "Second image does not contain valid size information");
        } else {
            int intValue = exifAttribute.getIntValue(this.mExifByteOrder);
            int intValue2 = exifAttribute2.getIntValue(this.mExifByteOrder);
