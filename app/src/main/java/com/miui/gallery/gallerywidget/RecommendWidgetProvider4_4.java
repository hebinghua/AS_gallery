...
public class RecommendWidgetProvider4_4 extends RecommendWidgetProviderBase {
    ...
    public IWidgetProviderConfig.WidgetSize getWidgetType() {
        return IWidgetProviderConfig.WidgetSize.SIZE_4_4;
    }

    @Override // com.miui.gallery.gallerywidget.common.IWidgetProviderConfig
    public int getRemoteViewID() {
        return WidgetInstallManager.isUseSmallLayout() ? R.layout.recommend_widget_small_content4_4 : R.layout.recommend_widget_content4_4;
    }
}
