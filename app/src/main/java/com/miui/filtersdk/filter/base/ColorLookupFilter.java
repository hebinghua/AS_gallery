...
public class ColorLookupFilter extends BaseOriginalFilter {
    ...
    public void onInitialized() {
        super.onInitialized();
        runOnDraw(new Runnable() { // from class: com.miui.filtersdk.filter.base.ColorLookupFilter.1
            @Override // java.lang.Runnable
            public void run() {
                ColorLookupFilter colorLookupFilter = ColorLookupFilter.this;
                colorLookupFilter.mLookupSourceTexture = OpenGlUtils.loadTexture(BeautificationSDK.sContext, colorLookupFilter.mTable);
            }
        });
    }
