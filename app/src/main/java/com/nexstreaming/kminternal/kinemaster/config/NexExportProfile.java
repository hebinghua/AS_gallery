...
public class NexExportProfile implements Serializable {
    ...
    public static final NexExportProfile EXPORT_960_540 = new NexExportProfile(960, UIMsg.MsgDefine.MSG_NETWORK_CHANNEL, UIMsg.MsgDefine.MSG_NETWORK_CHANNEL, 3145728, 3);
    public static final NexExportProfile EXPORT_960_544 = new NexExportProfile(960, 544, UIMsg.MsgDefine.MSG_NETWORK_CHANNEL, 3145728, 3);
    ...
    public static final NexExportProfile EXPORT_400_240 = new NexExportProfile(StatusCode.BAD_REQUEST, 240, 240, nexEngine.ExportHEVCHighTierLevel52, 4);
    ...
    public static List<NexExportProfile> getExportProfiles(int i) {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            if (CamcorderProfile.hasProfile(iArr[i2]) && (camcorderProfile = CamcorderProfile.get(iArr[i2])) != null) {
                int i3 = camcorderProfile.videoFrameHeight;
                int i4 = camcorderProfile.videoFrameWidth;
                if (i3 * i4 <= i) {
                    arrayList.add(new NexExportProfile(i4, i3, i3, camcorderProfile.videoBitRate, getLabelResource(i4, i3)));
                }
            }
        }
        return arrayList;
        ...
        while (true) {
            ...
            if (CamcorderProfile.hasProfile(iArr[i3]) && (camcorderProfile = CamcorderProfile.get(iArr[i3])) != null) {
                ...
                if (abs < 32 && abs2 < 32) {
                    ...
                    nexExportProfile = new NexExportProfile(i4, i5, i5, camcorderProfile.videoBitRate, getLabelResource(i4, i5));
                    break;
                }
            }
            i3++;
