...
public class VendorList {
    ...
    public static Map<String, vendor> builtinVendor() {
    ...
    public String getAssetStoreAppPackageName(String str) {
        init();
        vendor vendorVar = this.m_builtinVendors.get(str);
        return vendorVar == null ? assetStoreAppGlobalPackageName : vendorVar.getAssetStoreAppPackageName();
    }

    public String getAssetStoreAppServiceName(String str) {
        init();
        vendor vendorVar = this.m_builtinVendors.get(str);
        return vendorVar == null ? "com.nexstreaming.app.vasset.global.AssetStoreService" : vendorVar.getAssetStoreAppServiceName();
    }

    public String getKineMasterPackageName(String str) {
        init();
        vendor vendorVar = this.m_builtinVendors.get(str);
        return vendorVar == null ? KineMasterPackageName : vendorVar.getKineMasterPackageName();
    }
}
