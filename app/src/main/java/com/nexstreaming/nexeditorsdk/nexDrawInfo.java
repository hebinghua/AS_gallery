...
public class nexDrawInfo {
    ...
    public List<d> subTemplateDrawInfos;
    ...
    public void print() {
        Log.d(TAG, String.format("nexDrawInfo id : %d", Integer.valueOf(this.mID)));
        Log.d(TAG, String.format("nexDrawInfo clip : %d", Integer.valueOf(this.mClipID)));
        Log.d(TAG, String.format("nexDrawInfo subID : %d", Integer.valueOf(this.mSubEffectID)));
        Log.d(TAG, String.format("nexDrawInfo start : %d", Integer.valueOf(this.mStartTime)));
        Log.d(TAG, String.format("nexDrawInfo end : %d", Integer.valueOf(this.mEndTime)));
        String str = TAG;
        ...
        Log.d(TAG, String.format("nexDrawInfo istransition : %d", Integer.valueOf(this.mIsTransition)));
        Log.d(TAG, String.format("nexDrawInfo color : %d %d %d", Integer.valueOf(this.mBrightness), Integer.valueOf(this.mContrast), Integer.valueOf(this.mSaturation)));
        Log.d(TAG, String.format("nexDrawInfo lut : %d", Integer.valueOf(this.mLUT)));
        Log.d(TAG, String.format("nexDrawInfo start rect : %d %d %d %d", Integer.valueOf(this.mStartRect.left), Integer.valueOf(this.mStartRect.top), Integer.valueOf(this.mStartRect.right), Integer.valueOf(this.mStartRect.bottom)));
        Log.d(TAG, String.format("nexDrawInfo end rect : %d %d %d %d", Integer.valueOf(this.mEndRect.left), Integer.valueOf(this.mEndRect.top), Integer.valueOf(this.mEndRect.right), Integer.valueOf(this.mEndRect.bottom)));
        Log.d(TAG, String.format("nexDrawInfo face rect : %d %d %d %d", Integer.valueOf(this.mEndRect.left), Integer.valueOf(this.mEndRect.top), Integer.valueOf(this.mEndRect.right), Integer.valueOf(this.mEndRect.bottom)));
        Log.d(TAG, String.format("nexDrawInfo ratio : %f", Float.valueOf(this.mRatio)));
        Log.d(TAG, "---------------------------------------------------");
    }
}
