...
public class nexAssetStoreAppUtils {
    ...
    public static void makeConfigAsync() {
        new AsyncTask<Void, Void, Void>() { // from class: com.nexstreaming.nexeditorsdk.nexAssetStoreAppUtils.1
    ...
    public static boolean isServiceRunningCheck(Context context) {
        if (context == null) {
            context = com.nexstreaming.kminternal.kinemaster.config.a.a().b();
        }
    ...
    public static int runAssetStoreApp(Activity activity, String str, int i) {
        ...
        if (str != null) {
            if (!str.startsWith("FL")) {
                intent.putExtra(kAssetStoreAssetImageUrl, AssetLocalInstallDB.getInstance(com.nexstreaming.kminternal.kinemaster.config.a.a().b()).getThumbnailUrl(Integer.parseInt(str)));
            }
