...
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object> {
    public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() { // from class: com.google.gson_nex.internal.bind.ArrayTypeAdapter.1
    ...
    public Object mo352read(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            arrayList.add(this.componentTypeAdapter.mo352read(jsonReader));
        }
        jsonReader.endArray();
