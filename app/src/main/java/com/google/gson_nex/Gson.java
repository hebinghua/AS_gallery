...
public final class Gson {
    ...
    public Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new JsonDeserializationContext() { // from class: com.google.gson_nex.Gson.1
            @Override // com.google.gson_nex.JsonDeserializationContext
            public <T> T deserialize(JsonElement jsonElement, Type type) throws JsonParseException {
                return (T) Gson.this.fromJson(jsonElement, type);
            }
        };
        this.serializationContext = new JsonSerializationContext() { // from class: com.google.gson_nex.Gson.2
            @Override // com.google.gson_nex.JsonSerializationContext
    ...
    private TypeAdapter<Number> doubleAdapter(boolean z) {
        ...
        return new TypeAdapter<Number>() { // from class: com.google.gson_nex.Gson.3
    ...
    private TypeAdapter<Number> floatAdapter(boolean z) {
        ...
        return new TypeAdapter<Number>() { // from class: com.google.gson_nex.Gson.4
            @Override // com.google.gson_nex.TypeAdapter
            /* renamed from: read */
            public Number mo352read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
    ...
    private TypeAdapter<Number> longAdapter(LongSerializationPolicy longSerializationPolicy) {
        ...
        return new TypeAdapter<Number>() { // from class: com.google.gson_nex.Gson.5
        ...
        try {
            try {
                try {
                    jsonReader.peek();
                    z = false;
                    T mo352read = getAdapter(TypeToken.get(type)).mo352read(jsonReader);
    ...
    public static class FutureTypeAdapter<T> extends TypeAdapter<T> {
        ...
        public T mo352read(JsonReader jsonReader) throws IOException {
            ...
            return typeAdapter.mo352read(jsonReader);
        }
