...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    public final void moveEntryToIndex(int i, int i2) {
        int i3;
        int i4;
        if (i == i2) {
            return;
    ...
    public static abstract class View<K, V, T> extends AbstractSet<T> {
        ...
        public abstract T mo258forEntry(int i);
        ...
        public Iterator<T> iterator() {
            return new Iterator<T>() { // from class: com.google.common.collect.HashBiMap.View.1
                ...
                public T next() {
                    ...
                    T t = (T) View.this.mo258forEntry(this.index);
    ...
    public final class EntrySet extends View<K, V, Map.Entry<K, V>> {
        ...
        public Map.Entry<K, V> mo258forEntry(int i) {
    ...
    public static class InverseEntrySet<K, V> extends View<K, V, Map.Entry<V, K>> {
        ...
        @Override // com.google.common.collect.HashBiMap.View
        /* renamed from: forEntry  reason: collision with other method in class */
        public Map.Entry<V, K> mo258forEntry(int i) {
