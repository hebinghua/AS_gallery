...
public final class HighLevelEncoder {
    ...
    public static void illegalCharacter(char c) {
        String hexString;
        throw new IllegalArgumentException("Illegal character: " + c + " (0x" + (String.valueOf("0000".substring(0, 4 - hexString.length())) + Integer.toHexString(c)) + CoreConstants.RIGHT_PARENTHESIS_CHAR);
    }
}
