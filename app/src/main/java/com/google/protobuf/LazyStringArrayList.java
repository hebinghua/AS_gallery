...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    public LazyStringArrayList mo430mutableCopyWithCapacity(int i) {
        if (i < size()) {
    ...
    public String mo428remove(int i) {
        ensureIsMutable();
    ...
    public static class ByteArrayListView extends AbstractList<byte[]> implements RandomAccess {
        ...
        public byte[] remove(int i) {
            String mo428remove = this.list.mo428remove(i);
            ((AbstractList) this).modCount++;
            return LazyStringArrayList.asByteArray(mo428remove);
        }
    }
    ...
    public static class ByteStringListView extends AbstractList<ByteString> implements RandomAccess {
        ...
        @Override // java.util.AbstractList, java.util.List
        /* renamed from: get */
        public ByteString mo424get(int i) {
        ...
        @Override // java.util.AbstractList, java.util.List
        /* renamed from: remove */
        public ByteString mo425remove(int i) {
            String mo428remove = this.list.mo428remove(i);
            ((AbstractList) this).modCount++;
            return LazyStringArrayList.asByteString(mo428remove);
        }
    }
