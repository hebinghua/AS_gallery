...
public class MapEntryLite<K, V> {
    ...
    public static <T> T parseField(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, WireFormat.FieldType fieldType, T t) throws IOException {
        ...
        if (i == 1) {
            MessageLite.Builder mo402toBuilder = ((MessageLite) t).mo402toBuilder();
            codedInputStream.readMessage(mo402toBuilder, extensionRegistryLite);
            return (T) mo402toBuilder.mo414buildPartial();
        } else if (i == 2) {
