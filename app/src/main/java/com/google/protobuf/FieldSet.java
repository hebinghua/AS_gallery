...
public final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    private void mergeFromField(Map.Entry<T, Object> entry) {
        ...
        if (key.isRepeated()) {
            ...
            this.fields.put((SmallSortedMap<T, Object>) key, (T) key.internalMergeFrom(((MessageLite) field2).mo402toBuilder(), (MessageLite) value).mo403build());
        } else {
            this.fields.put((SmallSortedMap<T, Object>) key, (T) cloneIfMutable(value));
        }
    }
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private static Object replaceBuilder(Object obj) {
            return obj instanceof MessageLite.Builder ? ((MessageLite.Builder) obj).mo403build() : obj;
        }
