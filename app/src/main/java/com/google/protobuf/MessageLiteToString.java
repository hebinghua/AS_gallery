...
public final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (java.lang.reflect.Method method : messageLite.getClass().getDeclaredMethods()) {
            ...
            if (method.getParameterTypes().length == 0) {
                ...
                if (method.getName().startsWith(CallMethod.METHOD_GET)) {
                    treeSet.add(method.getName());
                }
            }
        }
        for (String str : treeSet) {
            String substring = str.startsWith(CallMethod.METHOD_GET) ? str.substring(3) : str;
            boolean z = true;
            ...
            if (((java.lang.reflect.Method) hashMap2.get("set" + substring)) != null) {
                if (substring.endsWith(BYTES_SUFFIX)) {
                    if (hashMap.containsKey(CallMethod.METHOD_GET + substring.substring(0, substring.length() - 5))) {
                    }
                }
                String str4 = substring.substring(0, 1).toLowerCase() + substring.substring(1);
                java.lang.reflect.Method method4 = (java.lang.reflect.Method) hashMap.get(CallMethod.METHOD_GET + substring);
    ...
    private static boolean isDefaultValue(Object obj) {
        ...
        if (obj instanceof Integer) {
            ...
            return ((Double) obj).doubleValue() == SearchStatUtils.POW;
            ...
            return obj instanceof MessageLite ? obj == ((MessageLite) obj).mo408getDefaultInstanceForType() : (obj instanceof java.lang.Enum) && ((java.lang.Enum) obj).ordinal() == 0;
        }
    }
    ...
    public static final void printField(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                ...
                int i4 = i + 2;
                printField(sb, i4, Action.KEY_ATTRIBUTE, entry2.getKey());
