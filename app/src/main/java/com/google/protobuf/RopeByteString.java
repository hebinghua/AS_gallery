...
public final class RopeByteString extends ByteString {
        ...
        return new ByteString.AbstractByteIterator() { // from class: com.google.protobuf.RopeByteString.1
            ...
            private ByteString.ByteIterator nextPiece() {
                if (this.pieces.hasNext()) {
                    return this.pieces.mo431next().iterator2();
                }
                return null;
            }
    ...
    public List<ByteBuffer> asReadOnlyByteBufferList() {
        ...
        while (pieceIterator.hasNext()) {
            arrayList.add(pieceIterator.mo431next().asReadOnlyByteBuffer());
        }
        return arrayList;
    }
    ...
    public static final class PieceIterator implements Iterator<ByteString.LeafByteString> {
        ...
        @Override // java.util.Iterator
        /* renamed from: next */
        public ByteString.LeafByteString mo431next() {
    ...
    public class RopeInputStream extends InputStream {
        ...
        private void initialize() {
            ...
            ByteString.LeafByteString mo431next = pieceIterator.mo431next();
            this.currentPiece = mo431next;
            this.currentPieceSize = mo431next.size();
        ...
        private void advanceIfCurrentPieceFullyRead() {
            if (this.currentPiece != null) {
                ...
                if (this.pieceIterator.hasNext()) {
                    ByteString.LeafByteString mo431next = this.pieceIterator.mo431next();
                    this.currentPiece = mo431next;
                    this.currentPieceSize = mo431next.size();
                    return;
                }
