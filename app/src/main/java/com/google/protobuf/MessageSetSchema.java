...
final class MessageSetSchema<T> implements Schema<T> {
    ...
    public T newInstance() {
        return (T) this.defaultInstance.mo401newBuilderForType().mo414buildPartial();
    }
    ...
    public int hashCode(T t) {
        int hashCode = this.unknownFieldSchema.mo437getFromMessage(t).hashCode();
    ...
    private <UT, UB> void writeUnknownFieldsHelper(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t, Writer writer) throws IOException {
        unknownFieldSchema.writeAsMessageSetTo(unknownFieldSchema.mo437getFromMessage(t), writer);
    }
    ...
    */
    ...
    private <UT, UB, ET extends FieldSet.FieldDescriptorLite<ET>> void mergeFromHelper(UnknownFieldSchema<UT, UB> unknownFieldSchema, ExtensionSchema<ET> extensionSchema, T t, Reader reader, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        UB mo436getBuilderFromMessage = unknownFieldSchema.mo436getBuilderFromMessage(t);
        ...
        do {
            try {
                ...
                unknownFieldSchema.setBuilderToMessage(t, mo436getBuilderFromMessage);
            }
        } while (parseMessageSetItemOrUnknownField(reader, extensionRegistryLite, extensionSchema, mutableExtensions, unknownFieldSchema, mo436getBuilderFromMessage));
    }
    ...
    private <UT, UB> int getUnknownFieldsSerializedSize(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t) {
        return unknownFieldSchema.getSerializedSizeAsMessageSet(unknownFieldSchema.mo437getFromMessage(t));
    }
}
