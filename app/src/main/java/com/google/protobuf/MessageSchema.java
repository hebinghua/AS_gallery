...
public final class MessageSchema<T> implements Schema<T> {
    ...
    */
    ...
    public static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo structuralMessageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        return new MessageSchema<>(iArr, objArr, fieldNumber, fieldNumber2, structuralMessageInfo.getDefaultInstance(), z, true, iArr4, checkInitialized.length, checkInitialized.length + iArr3.length, newInstanceSchema, listFieldSchema, unknownFieldSchema, extensionSchema, mapFieldSchema);
    }
    ...
    */
    ...
    public boolean equals(T t, T t2) {
        ...
        if (!this.unknownFieldSchema.mo437getFromMessage(t).equals(this.unknownFieldSchema.mo437getFromMessage(t2))) {
            return false;
        }
    ...
    public int hashCode(T t) {
        ...
        int hashCode = (i2 * 53) + this.unknownFieldSchema.mo437getFromMessage(t).hashCode();
            ...
            switch (type) {
                case 0:
                    if ((i7 & i2) == 0) {
                        ...
                        computeDoubleSize = CodedOutputStream.computeDoubleSize(numberAt, SearchStatUtils.POW);
                ...
                case 51:
                    if (isOneofPresent(t, numberAt, i5)) {
                        computeBoolSize = CodedOutputStream.computeDoubleSize(numberAt, SearchStatUtils.POW);
                        i6 += computeBoolSize;
                    }
                    break;
                case 52:
    ...
    private <UT, UB> int getUnknownFieldsSerializedSize(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t) {
        return unknownFieldSchema.getSerializedSize(unknownFieldSchema.mo437getFromMessage(t));
    }
    ...
    */
    ...
    private <UT, UB> void writeUnknownInMessageTo(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t, Writer writer) throws IOException {
        unknownFieldSchema.writeTo(unknownFieldSchema.mo437getFromMessage(t), writer);
    }
    ...
    */
    ...
    private int parseRepeatedField(T t, byte[] bArr, int i, int i2, int i3, int i4, int i5, int i6, long j, int i7, long j2, ArrayDecoders.Registers registers) throws IOException {
        ...
        if (!protobufList.isModifiable()) {
            ...
            protobufList = protobufList.mo430mutableCopyWithCapacity(size == 0 ? 10 : size * 2);
    ...
    */
    ...
    private final <K, V, UT, UB> UB filterUnknownEnumMap(int i, int i2, Map<K, V> map, Internal.EnumVerifier enumVerifier, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        ...
        while (it.hasNext()) {
            ...
            if (!enumVerifier.isInRange(((Integer) next.getValue()).intValue())) {
                if (ub == null) {
                    ub = unknownFieldSchema.mo438newBuilder();
                }
    ...
    private boolean isFieldPresent(T t, int i) {
        ...
        switch (type(typeAndOffsetAt)) {
            case 0:
                return UnsafeUtil.getDouble(t, offset) != SearchStatUtils.POW;
            case 1:
