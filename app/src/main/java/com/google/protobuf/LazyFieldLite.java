...
public class LazyFieldLite {
    ...
    public boolean equals(Object obj) {
        ...
        if (messageLite != null) {
            return messageLite.equals(lazyFieldLite.getValue(messageLite.mo408getDefaultInstanceForType()));
        }
        return getValue(messageLite2.mo408getDefaultInstanceForType()).equals(messageLite2);
    }
    ...
    public void merge(LazyFieldLite lazyFieldLite) {
        ...
        if (byteString2 != null && (byteString = lazyFieldLite.delayedBytes) != null) {
            ...
            setValue(this.value.mo402toBuilder().mo358mergeFrom(lazyFieldLite.value).mo403build());
        }
    }
    ...
    public void mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        ...
        try {
            setValue(this.value.mo402toBuilder().mo409mergeFrom(codedInputStream, extensionRegistryLite).mo403build());
    ...
    private static MessageLite mergeValueAndBytes(MessageLite messageLite, ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
        try {
            return messageLite.mo402toBuilder().mo355mergeFrom(byteString, extensionRegistryLite).mo403build();
        } catch (InvalidProtocolBufferException unused) {
            return messageLite;
        }
    }
        ...
        synchronized (this) {
            ...
            try {
                if (this.delayedBytes != null) {
                    this.value = messageLite.getParserForType().mo368parseFrom(this.delayedBytes, this.extensionRegistry);
