...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo1872read(JsonReader jsonReader) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K mo1872read = this.keyTypeAdapter.mo1872read(jsonReader);
                    if (construct.put(mo1872read, this.valueTypeAdapter.mo1872read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo1872read);
                    }
                    jsonReader.endArray();
                }
                jsonReader.endArray();
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K mo1872read2 = this.keyTypeAdapter.mo1872read(jsonReader);
                    if (construct.put(mo1872read2, this.valueTypeAdapter.mo1872read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo1872read2);
                    }
                }
