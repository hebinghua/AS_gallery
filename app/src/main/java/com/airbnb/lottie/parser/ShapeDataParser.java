...
public class ShapeDataParser implements ValueParser<ShapeData> {
    ...
    public static final JsonReader.Options NAMES = JsonReader.Options.of("c", "v", IntegerTokenConverter.CONVERTER_KEY, o.a);

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // com.airbnb.lottie.parser.ValueParser
    /* renamed from: parse */
    public ShapeData mo202parse(JsonReader jsonReader, float f) throws IOException {
