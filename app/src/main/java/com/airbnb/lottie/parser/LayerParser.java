...
public class LayerParser {
    public static final JsonReader.Options NAMES = JsonReader.Options.of("nm", "ind", "refId", MapBundleKey.MapObjKey.OBJ_TYPE, "parent", "sw", "sh", "sc", "ks", "tt", "masksProperties", "shapes", "t", "ef", d.Y, d.n, "w", "h", "ip", "op", "tm", "cl", "hd");
    public static final JsonReader.Options TEXT_NAMES = JsonReader.Options.of("d", a.a);
