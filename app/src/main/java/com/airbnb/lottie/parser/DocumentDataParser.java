...
public class DocumentDataParser implements ValueParser<DocumentData> {
    ...
    public static final JsonReader.Options NAMES = JsonReader.Options.of("t", "f", "s", "j", "tr", "lh", "ls", d.ak, "sc", "sw", MapBundleKey.MapObjKey.OBJ_OFFSET);

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // com.airbnb.lottie.parser.ValueParser
    /* renamed from: parse */
    public DocumentData mo202parse(JsonReader jsonReader, float f) throws IOException {
