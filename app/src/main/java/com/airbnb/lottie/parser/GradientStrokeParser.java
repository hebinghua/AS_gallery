...
public class GradientStrokeParser {
    public static JsonReader.Options NAMES = JsonReader.Options.of("nm", "g", o.a, "t", "s", "e", "w", "lc", "lj", "ml", "hd", "d");
    public static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.of(d.e, "k");
