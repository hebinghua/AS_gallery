...
public class KeyframeParser {
    ...
    public static JsonReader.Options NAMES = JsonReader.Options.of("t", "s", "e", o.a, IntegerTokenConverter.CONVERTER_KEY, "h", "to", "ti");
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(NAMES)) {
                case 0:
                    ...
                    break;
                case 1:
                    t3 = valueParser.mo202parse(jsonReader, f);
                    break;
                case 2:
                    t2 = valueParser.mo202parse(jsonReader, f);
                    break;
                case 3:
    ...
    public static <T> Keyframe<T> parseStaticValue(JsonReader jsonReader, float f, ValueParser<T> valueParser) throws IOException {
        return new Keyframe<>(valueParser.mo202parse(jsonReader, f));
    }
}
