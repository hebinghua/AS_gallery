...
public class TextLayer extends BaseLayer {
    ...
    public TextLayer(LottieDrawable lottieDrawable, Layer layer) {
        ...
        TextKeyframeAnimation mo193createAnimation = layer.getText().mo193createAnimation();
        this.textAnimation = mo193createAnimation;
        ...
        if (textProperties != null && (animatableColorValue2 = textProperties.color) != null) {
            BaseKeyframeAnimation<Integer, Integer> mo193createAnimation2 = animatableColorValue2.mo193createAnimation();
            this.colorAnimation = mo193createAnimation2;
            mo193createAnimation2.addUpdateListener(this);
            addAnimation(this.colorAnimation);
        }
        if (textProperties != null && (animatableColorValue = textProperties.stroke) != null) {
            BaseKeyframeAnimation<Integer, Integer> mo193createAnimation3 = animatableColorValue.mo193createAnimation();
            this.strokeColorAnimation = mo193createAnimation3;
        ...
        if (textProperties != null && (animatableFloatValue2 = textProperties.strokeWidth) != null) {
            BaseKeyframeAnimation<Float, Float> mo193createAnimation4 = animatableFloatValue2.mo193createAnimation();
            this.strokeWidthAnimation = mo193createAnimation4;
        ...
        BaseKeyframeAnimation<Float, Float> mo193createAnimation5 = animatableFloatValue.mo193createAnimation();
        this.trackingAnimation = mo193createAnimation5;
        mo193createAnimation5.addUpdateListener(this);
    ...
    public void drawLayer(Canvas canvas, Matrix matrix, int i) {
        ...
        DocumentData mo190getValue = this.textAnimation.mo190getValue();
        Font font = this.composition.getFonts().get(mo190getValue.fontName);
        if (font == null) {
            canvas.restore();
            return;
        }
        ...
        if (baseKeyframeAnimation != null) {
            this.fillPaint.setColor(baseKeyframeAnimation.mo190getValue().intValue());
        } else {
            BaseKeyframeAnimation<Integer, Integer> baseKeyframeAnimation2 = this.colorAnimation;
            if (baseKeyframeAnimation2 != null) {
                this.fillPaint.setColor(baseKeyframeAnimation2.mo190getValue().intValue());
            } else {
                this.fillPaint.setColor(mo190getValue.color);
            }
        }
        BaseKeyframeAnimation<Integer, Integer> baseKeyframeAnimation3 = this.strokeColorCallbackAnimation;
        if (baseKeyframeAnimation3 != null) {
            this.strokePaint.setColor(baseKeyframeAnimation3.mo190getValue().intValue());
        } else {
            BaseKeyframeAnimation<Integer, Integer> baseKeyframeAnimation4 = this.strokeColorAnimation;
            if (baseKeyframeAnimation4 != null) {
                this.strokePaint.setColor(baseKeyframeAnimation4.mo190getValue().intValue());
            } else {
                this.strokePaint.setColor(mo190getValue.strokeColor);
            }
        }
        int intValue = ((this.transform.getOpacity() == null ? 100 : this.transform.getOpacity().mo190getValue().intValue()) * 255) / 100;
        this.fillPaint.setAlpha(intValue);
        this.strokePaint.setAlpha(intValue);
        BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation5 = this.strokeWidthCallbackAnimation;
        if (baseKeyframeAnimation5 != null) {
            this.strokePaint.setStrokeWidth(baseKeyframeAnimation5.mo190getValue().floatValue());
        } else {
            BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation6 = this.strokeWidthAnimation;
            if (baseKeyframeAnimation6 != null) {
                this.strokePaint.setStrokeWidth(baseKeyframeAnimation6.mo190getValue().floatValue());
            } else {
                this.strokePaint.setStrokeWidth(mo190getValue.strokeWidth * Utils.dpScale() * Utils.getScale(matrix));
            }
        }
        if (this.lottieDrawable.useTextGlyphs()) {
            drawTextGlyphs(mo190getValue, matrix, font, canvas);
        } else {
            drawTextWithFont(mo190getValue, font, matrix, canvas);
        }
        canvas.restore();
    }
    ...
    public final void drawTextGlyphs(DocumentData documentData, Matrix matrix, Font font, Canvas canvas) {
        ...
        if (baseKeyframeAnimation != null) {
            f = baseKeyframeAnimation.mo190getValue().floatValue();
        } else {
            BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation2 = this.textSizeAnimation;
            if (baseKeyframeAnimation2 != null) {
                f = baseKeyframeAnimation2.mo190getValue().floatValue();
            } else {
                f = documentData.size;
            }
        }
    ...
    public final void drawGlyphTextLine(String str, DocumentData documentData, Matrix matrix, Font font, Canvas canvas, float f, float f2) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (fontCharacter != null) {
                ...
                if (baseKeyframeAnimation != null) {
                    floatValue = baseKeyframeAnimation.mo190getValue().floatValue();
                } else {
