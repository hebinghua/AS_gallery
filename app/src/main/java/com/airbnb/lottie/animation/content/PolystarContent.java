...
public class PolystarContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public PolystarContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, PolystarShape polystarShape) {
        ...
        BaseKeyframeAnimation<Float, Float> mo193createAnimation = polystarShape.getPoints().mo193createAnimation();
        this.pointsAnimation = mo193createAnimation;
        BaseKeyframeAnimation<PointF, PointF> mo193createAnimation2 = polystarShape.getPosition().mo193createAnimation();
        this.positionAnimation = mo193createAnimation2;
        BaseKeyframeAnimation<Float, Float> mo193createAnimation3 = polystarShape.getRotation().mo193createAnimation();
        this.rotationAnimation = mo193createAnimation3;
        BaseKeyframeAnimation<Float, Float> mo193createAnimation4 = polystarShape.getOuterRadius().mo193createAnimation();
        this.outerRadiusAnimation = mo193createAnimation4;
        BaseKeyframeAnimation<Float, Float> mo193createAnimation5 = polystarShape.getOuterRoundedness().mo193createAnimation();
        this.outerRoundednessAnimation = mo193createAnimation5;
        PolystarShape.Type type2 = PolystarShape.Type.STAR;
        if (type == type2) {
            this.innerRadiusAnimation = polystarShape.getInnerRadius().mo193createAnimation();
            this.innerRoundednessAnimation = polystarShape.getInnerRoundedness().mo193createAnimation();
        } else {
        ...
        baseLayer.addAnimation(mo193createAnimation5);
        if (type == type2) {
    ...
    public final void createStarPath() {
        ...
        float f8;
        float f9;
        float floatValue = this.pointsAnimation.mo190getValue().floatValue();
        double radians = Math.toRadians((this.rotationAnimation == null ? SearchStatUtils.POW : baseKeyframeAnimation.mo190getValue().floatValue()) - 90.0d);
        ...
        float floatValue2 = this.outerRadiusAnimation.mo190getValue().floatValue();
        float floatValue3 = this.innerRadiusAnimation.mo190getValue().floatValue();
        BaseKeyframeAnimation<?, Float> baseKeyframeAnimation2 = this.innerRoundednessAnimation;
        float floatValue4 = baseKeyframeAnimation2 != null ? baseKeyframeAnimation2.mo190getValue().floatValue() / 100.0f : 0.0f;
        BaseKeyframeAnimation<?, Float> baseKeyframeAnimation3 = this.outerRoundednessAnimation;
        float floatValue5 = baseKeyframeAnimation3 != null ? baseKeyframeAnimation3.mo190getValue().floatValue() / 100.0f : 0.0f;
        if (i2 != 0) {
        ...
        while (true) {
            ...
            if (d7 < ceil) {
                ...
                PointF mo190getValue = this.positionAnimation.mo190getValue();
                this.path.offset(mo190getValue.x, mo190getValue.y);
                this.path.close();
                return;
            }
        }
    ...
    public final void createPolygonPath() {
        ...
        double d3;
        int i;
        int floor = (int) Math.floor(this.pointsAnimation.mo190getValue().floatValue());
        double radians = Math.toRadians((this.rotationAnimation == null ? SearchStatUtils.POW : baseKeyframeAnimation.mo190getValue().floatValue()) - 90.0d);
        double d4 = floor;
        float floatValue = this.outerRoundednessAnimation.mo190getValue().floatValue() / 100.0f;
        float floatValue2 = this.outerRadiusAnimation.mo190getValue().floatValue();
