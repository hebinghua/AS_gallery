...
public class EllipseContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public EllipseContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, CircleShape circleShape) {
        ...
        BaseKeyframeAnimation<PointF, PointF> mo193createAnimation = circleShape.getSize().mo193createAnimation();
        this.sizeAnimation = mo193createAnimation;
        BaseKeyframeAnimation<PointF, PointF> mo193createAnimation2 = circleShape.getPosition().mo193createAnimation();
    ...
    public Path getPath() {
        ...
        this.path.offset(mo190getValue2.x, mo190getValue2.y);
        this.path.close();
