...
public class d {
    ...
    public class b {
        ...
        public double a(a aVar) {
            ...
            double d = aVar2.a;
            a aVar3 = this.a;
            a aVar4 = new a(d - aVar3.a, aVar2.b - aVar3.b);
            d dVar2 = d.this;
            double d2 = aVar.a;
            a aVar5 = this.a;
            a aVar6 = new a(d2 - aVar5.a, aVar.b - aVar5.b);
    ...
    private d() {
        ...
        while (i < length - 1) {
            ...
            double[] dArr2 = c;
            i++;
            linkedList.add(new b(new a(dArr[i] * 100000.0d, dArr2[i] * 100000.0d), new a(dArr[i] * 100000.0d, dArr2[i] * 100000.0d)));
        }
    }
