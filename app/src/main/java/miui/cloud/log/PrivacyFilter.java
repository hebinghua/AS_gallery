...
public class PrivacyFilter {
    public static Pattern sIpv4Pattern;
    public static Pattern sIpv6Pattern;
    ...
    public static String replacePrivacyLog(String str, Pattern pattern, String str2) {
        return pattern == null ? str : pattern.matcher(str).replaceAll(str2);
    }

    public static void initIpv4PatternString() {
        sIpv4Pattern = Pattern.compile("((\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])\\.){3}(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])");
    }

    public static void initIpv6PatternString() {
