...
public final class ParallelMap<T, R> extends ParallelFlowable<R> {
    ...
    public static final class ParallelMapSubscriber<T, R> implements FlowableSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            try {
                this.downstream.onNext(ObjectHelper.requireNonNull(this.mapper.mo2564apply(t), "The mapper returned a null value"));
            } catch (Throwable th) {
    ...
    public static final class ParallelMapConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T t) {
            ...
            try {
                return this.downstream.tryOnNext(ObjectHelper.requireNonNull(this.mapper.mo2564apply(t), "The mapper returned a null value"));
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                cancel();
                onError(th);
