...
public final class FlowableScalarXMap {
    public static <T, R> boolean tryScalarXMapSubscribe(Publisher<T> publisher, Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> function) {
        if (publisher instanceof Callable) {
            try {
                ...
                try {
                    Publisher publisher2 = (Publisher) ObjectHelper.requireNonNull(function.mo2564apply(obj), "The mapper returned a null Publisher");
    ...
    public static final class ScalarXMapFlowable<T, R> extends Flowable<R> {
        ...
        public void subscribeActual(Subscriber<? super R> subscriber) {
            try {
                Publisher publisher = (Publisher) ObjectHelper.requireNonNull(this.mapper.mo2564apply((T) this.value), "The mapper returned a null Publisher");
                if (publisher instanceof Callable) {
                    try {
